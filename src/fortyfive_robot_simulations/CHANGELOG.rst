^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package fortyfive_robot_simulations
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* deleted fortyfive_robot's gazebo plugins
...
* resolving dependency issues:
  http://build.ros.org/job/Kbin_dj_dJ64__fortyfive_robot_gazebo__debian_jessie_amd64__binary/2/
* Contributors: Pyo

1.0.0 (2018-05-29)
------------------
* added world for fortyfive_robot_autorace
* added world for fortyfive_robot_machine_learning
* merged pull request `#46 <https://github.com/ROBOTIS-GIT/turtlebot3_simulations/issues/46>`_ from AuTURBO/develop
  add fortyfive_robot_autorace world'
...
0.2.1 (2018-03-14)
------------------
* added worlds for gazebo and fortyfive_robot
* deleted fortyfive_robot_gazebo_plugin and merged into fortyfive_robot_gazebo_ros package
